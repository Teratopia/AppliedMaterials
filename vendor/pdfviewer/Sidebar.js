...
const Sidebar = ({ currentPage, doc, height, rotation, width, onJumpToDest, onJumpToPage }) => {
    ...
    const renderAttachmentTip = () => (React.createElement("div", { style: { padding: '8px' } }, l10n.sidebar.attachment));
    const renderBookmarkTip = () => (React.createElement("div", { style: { padding: '8px' } }, l10n.sidebar.bookmark));
    const renderThumbnailTip = () => (React.createElement("div", { style: { padding: '8px' } }, l10n.sidebar.thumbnail));
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { style: { padding: '0 2px' } },
                React.createElement(Tooltip, { position: Position.BottomCenter, target: (React.createElement(Button, { onClick: clickThumbnailTab, isSelected: tab === Tab.Thumbnail },
                        React.createElement(WrappedScrollingIcon, null))), content: renderThumbnailTip, offset: TOOLTIP_OFFSET })),
            React.createElement("div", { style: { padding: '0 2px' } },
                React.createElement(Tooltip, { position: Position.BottomCenter, target: (React.createElement(Button, { onClick: clickBookmarkTab, isSelected: tab === Tab.Bookmark },
                        React.createElement(BookmarkIcon, null))), content: renderBookmarkTip, offset: TOOLTIP_OFFSET })),
            React.createElement("div", { style: { padding: '0 2px' } },
                React.createElement(Tooltip, { position: Position.BottomCenter, target: (React.createElement(Button, { onClick: clickAttachmentTab, isSelected: tab === Tab.Attachment },
